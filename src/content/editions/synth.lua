...
SMODS.Edition {
    ...
    calculate = function(self, card, context)
        ...
        if (context.main_scoring and context.cardarea == G.play and equalize_count >= 1) or (context.joker_main and context.cardarea == G.jokers and equalize_count >= 1) then
            return {
