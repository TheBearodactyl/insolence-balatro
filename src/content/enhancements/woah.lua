...
SMODS.Enhancement({
    ...
    calculate = function(self, card, context)
        if context.cardarea == G.play and context.main_scoring then
            ...
            G.E_MANAGER:add_event(Event({
                ...
                delay = 0.2,
                func = function()
                    if insolence.mod.config.woah_sfx == true then
                        play_sound("ins_woah")
                    end
    ...
    update = function(self, card, dt)
        -- if libinsolence.count_num_of_joker("ins", "wulzy") >= 1 then
        ...
        -- end
        self.config.extra.e_chips_low = 50 * libinsolence.count_num_of_joker("ins", "wulzy")
        self.config.extra.e_mult_low = 10 * libinsolence.count_num_of_joker("ins", "wulzy")
    end,
})