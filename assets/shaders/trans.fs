...
extern MY_HIGHP_OR_MEDIUMP vec2 trans;
...
vec4 effect(vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords) {
	...
	vec3 blue = rgb_to_vec3(91, 206, 250);
	vec3 pink = rgb_to_vec3(245, 169, 184);
	...
	vec4 final_color = vec4(color, 1.0) * colour + clamp(trans.y, 0.0, 0.001);
	// tex.a = 0.75;
	final_color.a = 1;
